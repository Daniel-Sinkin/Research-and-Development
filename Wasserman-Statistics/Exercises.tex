...
\end{minted}
		...
		\item Find $P(C_i|B_4)$ where $B_4$ = "first head is obtained on toss $4$."
			\begin{itemize}
				\item We are interested in $P(H_1^c, H_2^c, H_3^c, H^4)$. Note that $P(H_2|H_1) = \frac{3}{4}$ and $P(H_1) = \frac{1}{2}$ as such $P(H_2, H_1) = P(H_2|H_1)P(H_1) = \frac{3}{4}\frac{1}{2} = \frac{3}{8}$.
			\end{itemize}
	\end{enumerate}
