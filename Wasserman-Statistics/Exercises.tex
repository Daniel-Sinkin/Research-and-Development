...
\begin{enumerate}
	\item Prove Theorem 7.3.
		...
		\end{itemize}
	\item Let $X_1, \dots, X_n \sim \operatorname{Bernoulli}(p)$ and let $Y_1 , ... , Y_m \sim \operatorname{Bernoulli}(q)$. Find the plug-in estimator and estimated standard error for $p$. Find an approximate $90$ percent confidence interval for $p$. Find the plug-in estimator and estimated standard error for $p - q$. Find an approximate $90$ percent confidence interval for $p - q$.
